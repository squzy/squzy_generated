...
func (m *CpuInfo_CPU) GetLoad() float32 {
	if m != nil {
		return m.Load
	}
	return 0
...
func (m *MemoryInfo_Memory) GetUsedPercent() float32 {
	if m != nil {
...
func (m *DiskInfo) GetUsedPercent() float32 {
	if m != nil {
		return m.UsedPercent
	}
	return 0
...
var fileDescriptor_06a40c128db68bfe = []byte{
	...
	0x49, 0xa4, 0x8d, 0xff, 0x36, 0x01, 0xb6, 0x27, 0x46, 0xa7, 0x60, 0x05, 0x34, 0xd0, 0xfd, 0xed,
	...
	0x91, 0xff, 0x1b, 0x3e, 0xfb, 0x3f, 0x00, 0x00, 0xff, 0xff, 0xec, 0x6a, 0x0f, 0x11, 0x4f, 0x08,
	0x00, 0x00,
}
