...
func (*SchedulerSnapshot_Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_56bb7e34c7817524, []int{0, 0}
}
...
func (*SchedulerSnapshot_MetaData) Descriptor() ([]byte, []int) {
	return fileDescriptor_56bb7e34c7817524, []int{0, 1}
}
...
var fileDescriptor_56bb7e34c7817524 = []byte{
	...
	,
}
