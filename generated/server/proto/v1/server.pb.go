...
func (m *AddSchedulerRequest) GetTimeout() int32 {
	if m != nil {
		return m.Timeout
	}
	return 0
...
type AddSchedulerRequest_TcpCheck struct {
	TcpCheck *TcpCheck `protobuf:"bytes,3,opt,name=tcp_check,json=tcpCheck,proto3,oneof"`
}

type AddSchedulerRequest_SitemapCheck struct {
	SitemapCheck *SiteMapCheck `protobuf:"bytes,4,opt,name=sitemap_check,json=sitemapCheck,proto3,oneof"`
}

type AddSchedulerRequest_GrpcCheck struct {
	GrpcCheck *GrpcCheck `protobuf:"bytes,5,opt,name=grpc_check,json=grpcCheck,proto3,oneof"`
}

type AddSchedulerRequest_HttpCheck struct {
	HttpCheck *HttpCheck `protobuf:"bytes,6,opt,name=http_check,json=httpCheck,proto3,oneof"`
}

type AddSchedulerRequest_HttpJsonValue struct {
	HttpJsonValue *HttpJsonValueCheck `protobuf:"bytes,7,opt,name=http_json_value,json=httpJsonValue,proto3,oneof"`
}
...
var fileDescriptor_84c2b3ce2e73d961 = []byte{
	...
	,
}
