...
type Log struct {
	Code                 StatusCode `protobuf:"varint,1,opt,name=code,proto3,enum=squzy.logger.v1.service.StatusCode" json:"code,omitempty"`
...
type MetaData struct {
	...
	Type                 Type                 `protobuf:"varint,5,opt,name=type,proto3,enum=squzy.logger.v1.service.Type" json:"type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func init() {
	proto.RegisterEnum("squzy.logger.v1.service.Type", Type_name, Type_value)
	proto.RegisterEnum("squzy.logger.v1.service.StatusCode", StatusCode_name, StatusCode_value)
	proto.RegisterType((*Log)(nil), "squzy.logger.v1.service.Log")
...
var fileDescriptor_9c9dc982bf39224e = []byte{
	...
	,
}
